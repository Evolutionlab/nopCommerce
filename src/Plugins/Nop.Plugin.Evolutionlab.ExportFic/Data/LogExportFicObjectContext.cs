...
namespace Nop.Plugin.Evolutionlab.ExportFic.Data
{
    ...
    /// Object context
    /// </summary>
    public class LogExportFicObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public LogExportFicObjectContext(string nameOrConnectionString)
        ...
        {
            modelBuilder.Configurations.Add(new LogExportFicRecordMap());
        ...
        {
            //drop the table
            var tableName = this.GetTableName<LogExportFicRecord>();
            //var tableName = "LogExportFatInCloud";
